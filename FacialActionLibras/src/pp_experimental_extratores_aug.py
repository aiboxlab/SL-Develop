...
def predict_all_db(base, config_experimental):
    ...
    db_input_aug = "../data/processed/"+base+"/"
    list_augs = os.listdir(db_input_aug)

    for aug in list_augs:

        db_input = "../data/processed/{}/{}/Videos/".format(base, aug)
        db_output_frames = "../data/raw/{}/{}/{}-frames/".format(base, aug, base)
        db_output = "../data/outputs/{}/{}/predicts_squeezenet/".format(base, aug)
        extension = ".mp4"
...
if __name__ == "__main__":
    ...
    raw_base = "HM-Libras-augmentation-teste-apagar"
