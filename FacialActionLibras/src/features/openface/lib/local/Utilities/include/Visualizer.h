...
namespace Utilities
{
	...
	*/
	...
	public:
		...
		Visualizer(bool vis_track, bool vis_hog, bool vis_align, bool vis_aus, bool vis_pose, bool vis_gaze, bool vis_lmk); //2wayavenue
		...
		bool vis_align;
		bool vis_aus;
		bool vis_pose; //2wayavenue
		bool vis_gaze; //2wayavenue
		bool vis_lmk; //2wayavenue
