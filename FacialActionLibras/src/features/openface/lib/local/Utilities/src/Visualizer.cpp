...
Visualizer::Visualizer(std::vector<std::string> arguments)
{
	...
	this->vis_aus = false;
	this->vis_gaze = false; //2wayavenue
	this->vis_pose = false; //2wayavenue
	this->vis_lmk = false; //2wayavenue
	...
	for (size_t i = 0; i < arguments.size(); ++i)
	{
		if (arguments[i].compare("-verbose") == 0)
		{
			...
			this->vis_hog = true;
			this->vis_aus = true;
			this->vis_gaze = true; //2wayavenue
			this->vis_pose = true; //2wayavenue
			this->vis_lmk = true; //2wayavenue
		}
		...
		else if (arguments[i].compare("-vis-gaze") == 0) //2wayavenue
		{
			this->vis_gaze = true;
		}
		else if (arguments[i].compare("-vis-pose") == 0) //2wayavenue
		{
			this->vis_pose = true;
		}
		else if (arguments[i].compare("-vis-lmk") == 0) //2wayavenue
		{
			this->vis_lmk = true;
		}
	}
...
//2wayavenue
Visualizer::Visualizer(bool vis_track, bool vis_hog, bool vis_align, bool vis_aus, bool vis_pose, bool vis_gaze, bool vis_lmk)
{
	this->vis_track = vis_track;
	this->vis_hog = vis_hog;
	this->vis_align = vis_align;
	this->vis_aus = vis_aus;
	this->vis_pose = vis_pose; //2wayavenue
	this->vis_gaze = vis_gaze; //2wayavenue
	this->vis_lmk = vis_lmk; //2wayavenue
}
